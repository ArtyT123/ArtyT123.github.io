...
if (isset($_POST['reset-request-submit'])) {
  ...
  $url = "www.autocalcrd.com/create-new-password.php?selector=" . $selector . "&validator=" . bin2hex($token);
  ...
  // Subject
  $subject = 'Reset your password for AutoCalc RD';

  // Message
  $message = '<p>We recieved a password reset request. <br>The link to reset your password is below. <br>';
  ...
  // Headers
  // Headers
  $headers = "From: AutoCalc RD <autocalcrd@gmail.com>\r\n";
  $headers .= "Reply-To: autocalcrd@gmail.com\r\n";
